...
if __name__ == '__main__':
  ...
  model = Model(num_input, en1_units_x, en2_units_x, num_coordinate, num_topic, dropout, variance_x, bs,
              embedding_tensor_words,emb_size,activation, "gaussian") # gaussian , inverse_quadratic
  ...
  x_list_w_pseudo,labels_list_w_pseudo,zphi,doc_ids_w_pseudo,beta,query_center,ir_query_center = test(trained_model,all_indices,train_vec,keywords_as_labels,num_topic,train_label,device)
