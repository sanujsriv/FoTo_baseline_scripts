...
from utils import flatten_list,get_topwords,get_embedding_tensor
from ranking import cosine_keywords
...
def get_cosine_sum_topics(all_topics,m_beta,topwords,id_vocab,embeddings,keywords):
  ...
  for topics in topics_wordlist:
    ...
    topics_wordsScores,*_ = cosine_keywords(keywords,topics_wordtensors,topics,embeddings)
