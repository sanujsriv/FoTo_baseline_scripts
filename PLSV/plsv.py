...
class Model(nn.Module):
    ...
    def forward(self, input_, compute_loss=False):  
        ...
        if compute_loss:
            return recon_v,zx, self.loss(input_, recon_v, zx_phi, posterior_mean, posterior_logvar, posterior_var, d)
        else:
            return z, recon_v, zx,zc, zx_phi
