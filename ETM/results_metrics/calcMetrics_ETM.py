...
labels = all_results['labels_list_w_pseudo']
...
relv_docs_in_vis_idx = [d.get(item) for item in relv_docs]
...
all_metrics['topics_wordlist'] = all_results['topics']
topics_wordlist = all_results['topics']
all_metrics['topics'] = [' '.join(t) for t in topics_wordlist]

# topics_10topwords = all_metrics['topics']
# topics_10topwords = [' '.join(t.split(' ')[:10]) for t in topics_10topwords]

all_metrics['sum_avg_cos'] = get_cosine_sum_topics(topics_wordlist,embeddings,keywords)
all_metrics['KNN'] =  all_results['KNN']        
all_metrics['aupr'] = all_results['aupr']
