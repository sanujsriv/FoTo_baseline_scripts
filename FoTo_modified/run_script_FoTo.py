...
for r in num_runs:
  ...
  # os.chdir(save_dir)
  print("nohup python3 main.py --dataset "+data_name+" --num_topic "+num_topic+" --run "+str(r)+" -e "+epochs+" -qs "+str(queryset))#+" > "+save_dir+"/"+"output_"+data_name+"_"+str(num_topic)+".txt")


  # print("python3 main.py \
  #  --dataset "+data_name+" --dtype "+dtype+" --num_topic "+num_topic+" --run "+str(r)+" -e "+epochs+" -qs "+str(queryset)+" > "+save_dir+"/"+"output_"+data_name+"_"+str(num_topic)+".txt")
